...
object CreateChatCompletionWithO3 extends Example {

  private val messages = Seq(
    // system message still works for o-series models but moving forward DeveloperMessage should be used instead
