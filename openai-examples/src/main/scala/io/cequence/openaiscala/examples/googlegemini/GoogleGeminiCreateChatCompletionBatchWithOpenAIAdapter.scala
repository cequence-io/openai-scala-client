...
/**
 * Runs a provider-agnostic chat-completion batch against the Gemini Batch API (50% of standard
 * cost) through the OpenAI adapter: submits the requests, polls until processing ends, prints
 * the results, and deletes the batch.
 *
 * Requires `GOOGLE_API_KEY`.
 */
object GoogleGeminiCreateChatCompletionBatchWithOpenAIAdapter
