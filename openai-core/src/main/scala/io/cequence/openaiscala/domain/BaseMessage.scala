...
final case class AssistantWebSearchMessage(
  // The contents of the message.
  content: String,
  ...
  def withName(name: String): AssistantWebSearchMessage = this.copy(name = Some(name))
}

// URL Citation annotation type
final case class Annotation(
  `type`: String,
  url_citation: Option[UrlCitation] = None
)
