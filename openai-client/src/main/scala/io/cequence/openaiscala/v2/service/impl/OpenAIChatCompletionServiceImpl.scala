...
import io.cequence.openaiscala.v2.service.ws.{WSRequestExtHelper, WSRequestHelper}
import io.cequence.openaiscala.v2.service.{OpenAIChatCompletionService, OpenAIServiceConsts}
